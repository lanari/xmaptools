function [Si_T1,XMg,XFe,Fe2,Fe3,Al_M1,Mg_M1,Fe_M1,Ca_M2,Na_M2,Xjd,Xdi,Xhed,Xacm,Xsum,SumM1,SumM2] = StructFctCpxWFe3(Data,handles)
% -
...
%     Fe3 Al_M1 Mg_M1 Fe_M1 Ca_M2 Na_M2 Xjd Xdi Xhed Xacm Xsum SumM1 SumM2
...
for i = 1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        Xsum(i) = Xhed(i)+Xjd(i)+Xdi(i)+Xacm(i);
