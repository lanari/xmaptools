function [SI,AL,FE,MG,MN,XMg,Xctd,Xfctd,Xmctd] = StructFctChloritoid(Data,handles)
% -
% XMapTools External Function: Structural formula of chloritoid 
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Chloritoid>Ctd-StructForm>StructFctChloritoid>Si Al Fe Mg Mn XMg Xctd 
%     Xfctd Xmctd>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
%   12 Oxygens
%
% 
% Created by P. Lanari (Octobre 2011) - Last update 15/10/13.
...
Xctd = zeros(1,length(Data(:,1)));
Xfctd = zeros(1,length(Data(:,1)));
Xmctd = zeros(1,length(Data(:,1)));
