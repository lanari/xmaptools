function [Si_T,Ti_T,Al_T,Al_M,Fe_M,Mg_M,Xcor,Xfcor] = StructFctCordierite(Data,handles)
% -
...
%     Fe_M Mg_M Xcor Xfcor>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
%   18 Oxygens
%
% 
...
Xcor = zeros(1,length(Data(:,1)));
Xfcor = zeros(1,length(Data(:,1)));
