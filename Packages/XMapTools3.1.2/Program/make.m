...
Dir_1=cd;
List_1={'Install_XMapTools','VER_XMapTools_804','XMapTools','XConvert_JEOL_SUN'};

Dir_2=[cd,'/Dev'];
List_2={'DensityPlot','DensityTriPlot','XmapWaitBar','GetGuiPosition_XMT'};

Dir_3=[cd,'/Modules'];
List_3={'VER_XMTFunctionsInfos_804' ...
    ...
    ,'XMTFunctionsInfos','XMTImportTool','XMTModBinary','XMTModGenerator','XMTModIDC' ...
    ,'XMTModRGB','XMTModSpider','XMTModTRC','XMTModTriPlot','XMTStandardizationTool' ...
    };
