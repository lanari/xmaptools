function [Si_T1,XMg,XFe,Al_M1,Mg_M1,Fe_M1,Ca_M2,Na_M2,Xjd,Xdi,Xhed,Xsum,SumM1,SumM2] = StructFctCpxW(Data,handles)
% -
...
for i = 1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        if Si_T1(i) < 0 ||  Al_M1(i) < 0 || Mg_M1(i) < 0 || Fe_M1(i) < 0 || ...
           ...
           Xdi(i) < 0 || Xhed(i) < 0 || abs(Al-Ca) > max([Al,Ca])/100*Tolerance
