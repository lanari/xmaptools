function [Al_M,Fe_M,Mg_M,Xher,Xspi] = StructFctFeMgSpinel(Data,handles)
% -
% XMapTools External Function: Structural formula of Spinel (Fe-Mg) 
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Spinel>FeMg_Spi-StructForm>StructFctFeMgSpinel>Al_M Fe_M Mg_M Xher 
%     Xspi>SiO2 TiO2 Al2O3 FeO MnO MgO CaO Na2O K2O>
%
%   4 Oxygens
%
% 
...
Xher = zeros(1,length(Data(:,1)));
Xspi = zeros(1,length(Data(:,1)));
