function [Si_t Fe_t Mg_t Mn_t fo fa teph] = StructFctOlivine(Data,handles)
% -
% XMapTools External Function: Structural formula of olivine
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Olivine>Oliv-StructForm>StructFctOlivine>Si Fe Mg Mn fo fa teph>SiO2 TiO2 
