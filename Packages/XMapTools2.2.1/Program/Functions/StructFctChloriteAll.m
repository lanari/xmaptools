function [SiT,Aliv,Alvi,DT,XAlvi,fe2,fe3,XMg,XFe,V_M1,Al_M1,Mg_M1,Fe2_M1,Al_M23,Mg_M23,Fe2_M23,Al_M4,Mg_M4,Fe2_M4,XAlfchl,XAmes,XClin,XDaph,XSud,XSum] = StructFctChloriteAll(Data,handles)
% -
...
%
% 
% Created by P. Lanari (May 2014) - Last update 04/05/14.
...
for i=1:length(Data(:,1)) % one by one
    ...
    if OnCal
        ...
        XAmes(i) = Al_M1(i);
        XClin(i) = Mg_M1(i) - Mg_M4(i);
        XDaph(i) = Fe2_M1(i) - Fe2_M4(i);
        XSud(i) = V_M1(i);
        
        XSum(i) = XAlfchl(i)+XAmes(i)+XClin(i)+XDaph(i)+XSud(i);
        
        
        if SiT(i) < 0 || Aliv(i) < 0 || Aliv(i) < 0 || DT(i) < 0 || XAlvi(i) < 0 || fe2(i) < 0 || fe3(i) < 0 || XMg(i) < 0 || XFe(i) < 0 || V_M1(i) < 0 || Al_M1(i) < 0 || Mg_M1(i) < 0 || Fe2_M1(i) < 0 || Al_M23(i) < 0 || Mg_M23(i) < 0 || Fe2_M23(i) < 0 || Al_M4(i) < 0 || Mg_M4(i) < 0 || Fe2_M4(i) < 0 || XAlfchl(i) < 0 || XAmes(i) < 0 || XClin(i) < 0 || XDaph(i) < 0 || XSud(i) < 0 || XSum(i) < 0
