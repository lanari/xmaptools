function [Si_t Al_t Fe_t Mg_t Mn_t fst mst mnst] = StructFctStaurolite(Data,handles)
% -
% XMapTools External Function: Structural formula of staurolite
%
%   [outputs] = function_Name(Data,handles);
%
%   1>Staurolite>Sta-StructForm>StructFctStaurolite>Si Al Fe Mg Mn fst mst 
