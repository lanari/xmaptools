function [Si_T1,Al_T1,XMg,XFe,Fe2,Fe3,Al_M1,Mg_M1,Fe2_M1,Fe3_M1,Ca_M2,Na_M2,Xjd,Xdi,Xhed,Xcats,Xacm,Xsum,SumM1,SumM2] = StructFctCpxFe3(Data,handles)
% -
...
%     Fe_M1 Ca_M2 Na_M2 Xjd Xdi Xhed Xsum SumM1 SumM2>SiO2 TiO2 Al2O3 FeO 
%     MnO MgO CaO Na2O K2O>
%
%   6 Oxygens
%
% 
% Created by P. Lanari (May 2012) - Last update 16/05/12.
...
%         end
        ...
        Xsum(i) = Xhed(i)+Xjd(i)+Xdi(i)+Xcats(i)+Xacm(i);
        ...
        if Si_T1(i) < 0 || Al_T1(i) < 0 || Al_M1(i) < 0 || Mg_M1(i) < 0 || Fe2_M1(i) < 0 || ...
           ...
           Xdi(i) < 0 || Xhed(i) < 0 || Fe3_M1(i) < 0 || Xacm(i) < 0
